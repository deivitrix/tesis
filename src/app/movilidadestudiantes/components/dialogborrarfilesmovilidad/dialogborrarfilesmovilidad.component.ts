...
@Component({
  ...
  templateUrl: './dialogborrarfilesmovilidad.component.html',
  styleUrls: ['./dialogborrarfilesmovilidad.component.css']
})
export class DialogborrarfilesmovilidadComponent implements OnInit {

  constructor(
    public dialoRef:MatDialogRef<DialogborrarfilesmovilidadComponent>,
