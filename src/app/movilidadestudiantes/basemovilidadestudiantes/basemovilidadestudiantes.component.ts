...
@Component({
  selector: 'app-basemovilidadestudiantes',
  templateUrl: './basemovilidadestudiantes.component.html',
  styleUrls: ['./basemovilidadestudiantes.component.css']
})
export class BasemovilidadestudiantesComponent implements OnInit {
